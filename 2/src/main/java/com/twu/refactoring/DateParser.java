...
public class DateParser {
    ...
    public Date parse() {
        ...
        validateYear(calculateYear());

        validateMonth(calculateMonth());

        validateDate(calculateDate());
        ...
        calendar.set(calculateYear(), calculateMonth() - 1, calculateDate(), hour, minute, 0);
